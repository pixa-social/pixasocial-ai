...
export const Select: React.FC<SelectProps> = ({ label, id, options, error, className = '', containerClassName = '', ...props }) => {
  const baseStyles = 'appearance-none block w-full pl-3 pr-10 py-2 border bg-card rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-ring focus:border-primary sm:text-sm text-foreground';

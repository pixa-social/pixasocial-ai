    ...
    switch (currentView) {
      ...
      case ViewName.ContentPlanner:
        return <ContentPlannerView 
                  ...
                  onAddContentLibraryAsset={handlers.addAsset} onNavigate={onNavigate} 
                />;
      case ViewName.Calendar:
        return <CalendarView 
                  scheduledPosts={scheduledPosts} contentDrafts={contentDrafts} personas={personas} operators={operators}
                  onUpdateScheduledPost={handlers.updateScheduledPost} onDeleteScheduledPost={handlers.deleteScheduledPost}
                  onNavigate={onNavigate} 
                />;
       case ViewName.ContentLibrary:
        return <ContentLibraryView 
                  assets={contentLibraryAssets} onAddAsset={handlers.addAsset}
                  onUpdateAsset={handlers.updateAsset} onRemoveAsset={handlers.removeAsset}
                />;
      ...
      case ViewName.SocialPoster:
        return <SocialPosterView
                  ...
                  onDeleteScheduledPost={handlers.deleteScheduledPost} onNavigate={onNavigate}
                />;
      ...
      case ViewName.Settings: 
        return <SettingsView 
                  ...
                  connectedAccounts={connectedAccounts} onAddConnectedAccount={handlers.addConnectedAccount}
      ...
      case ViewName.TeamChat:
        return <ChatView
                  ...
                  customChannels={customChannels} onAddCustomChannel={handlers.addCustomChannel}
